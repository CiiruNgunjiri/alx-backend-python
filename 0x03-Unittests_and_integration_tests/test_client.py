...
Contains feature-specific unit tests and
integration tests using real payloads.
"""
...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_url(self):
        ...
        Patch the org property to return a known
        payload and verify the url.
        """
    ...
    def test_public_repos(self, repo_payload, mock_get_json):
        """
        Test public_repos returns expected
        repo names from a mocked repos payload.

        Use patch to mock _public_repos_url
        property and get_json function.
        """
    ...
    def test_has_license(self, repo, license_key, expected):
        """
        Test that has_license correctly identifies
        if a repo license matches the license_key.
        """
        client = GithubOrgClient("test-org")
        try:
            result = client.has_license(repo, license_key)
        except Exception as e:
            print(f"Error in has_license with repo={repo}, license_key={license_key}: {e}")
            raise
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    Mocks requests.get to provide controlled org
    and repos data without external HTTP requests.
    """
    ...
    def test_public_repos(self):
        """public_repos returns expected list of repo names from fixture."""
        client = GithubOrgClient(self.org_payload["login"])
        self.assertEqual(client.public_repos(), self.expected_repos)

    def test_public_repos_with_license(self):
        """public_repos filters by license correctly from fixture."""
        client = GithubOrgClient(self.org_payload["login"])
        self.assertEqual(
