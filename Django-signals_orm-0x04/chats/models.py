...
class Message(models.Model):
    ...
    sender = models.ForeignKey(User, on_delete=models.CASCADE, related_name='chats_sent_messages')
    conversation = models.ForeignKey(Conversation, on_delete=models.CASCADE, related_name='chats_messages')
